...
class Site_msg_interface_benaceur {
	...
	public function init() {
		...
		if ( ($settings[ 'msg_interface_benaceur_enable_for_all' ] || ($settings[ 'msginterfacebenaceur_administrator' ] && $admin) ) && $settings[ 'msginterfacebenaceur_frontend' ]  ) {
    fmib_f();
		} elseif ( $settings[ 'msg_interface_benaceur_enable_for_all' ] || ($settings[ 'msginterfacebenaceur_administrator' ] && $admin)  ) {
    fmib();
		}
